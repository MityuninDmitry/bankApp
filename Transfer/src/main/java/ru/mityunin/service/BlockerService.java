...
public class BlockerService {
    ...
    public BlockerService(@Value("${service.blocker.url}") String blockerServiceUrl, RestTemplateHelper restTemplateHelper) {
        this.blockerServiceUrl = blockerServiceUrl;
        this.restTemplateHelper = restTemplateHelper;
    }

    public ApiResponse<Void> isBlockerOperation() {
        String blockerUrl = blockerServiceUrl + "/blocker/isBlockerOperation";
